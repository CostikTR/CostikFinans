...
function getBankLogo(bankName) {
    // Not: Bu fonksiyonun çalışması için /images/ klasörü altında ilgili SVG dosyalarının olması gerekir.
    // Bu ortamda dosya sistemi olmadığı için, gerçek bir sunucuda bu yolları doğrulamanız gerekir.
    // Şimdilik, logoların yer tutucusunu gösteriyoruz.
    const name = bankName.toLowerCase();
    const logoClass = "h-8 opacity-90";
    switch(name) {
        case 'garanti': return `<img src="https://placehold.co/100x40/2E8B57/FFFFFF?text=Garanti" class="${logoClass}" alt="Garanti Logo">`;
        case 'akbank': return `<img src="https://placehold.co/100x40/E30613/FFFFFF?text=Akbank" class="${logoClass}" alt="Akbank Logo">`;
        case 'iş bankası': return `<img src="https://placehold.co/100x40/005A9F/FFFFFF?text=İş+Bankası" class="${logoClass}" alt="İş Bankası Logo">`;
        case 'yapı kredi': return `<img src="https://placehold.co/100x40/004481/FFFFFF?text=Yapı+Kredi" class="${logoClass}" alt="Yapı Kredi Logo">`;
        case 'qnb finansbank': return `<img src="https://placehold.co/100x40/002D62/FFFFFF?text=QNB" class="${logoClass}" alt="QNB Finansbank Logo">`;
        case 'halkbank': return `<img src="https://placehold.co/100x40/E50000/FFFFFF?text=Halkbank" class="${logoClass}" alt="Halkbank Logo">`;
        case 'vakıfbank': return `<img src="https://placehold.co/100x40/F7D002/000000?text=Vakıfbank" class="${logoClass}" alt="Vakıfbank Logo">`;
        case 'ziraat bankası': return `<img src="https://placehold.co/100x40/A40000/FFFFFF?text=Ziraat" class="${logoClass}" alt="Ziraat Bankası Logo">`;
        case 'denizbank': return `<img src="https://placehold.co/100x40/005A9F/FFFFFF?text=Denizbank" class="${logoClass}" alt="Denizbank Logo">`;
        case 'ing': return `<img src="https://placehold.co/100x40/FF6600/FFFFFF?text=ING" class="${logoClass}" alt="ING Logo">`;
