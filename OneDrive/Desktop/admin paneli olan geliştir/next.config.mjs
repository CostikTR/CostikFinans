...
const nextConfig = {
  ...
  // Static export sadece render.com gibi platformlar için
  // output: 'export',
  trailingSlash: true,
  eslint: {
...
export default withPWA({
  ...
  runtimeCaching: [
    ...
    {
      urlPattern: /^https?:\/\/costikfinans\.site\/.*/i,
  ...
  disable: process.env.NODE_ENV === 'development', // PWA'yı development modunda devre dışı bırak
})(nextConfig)
