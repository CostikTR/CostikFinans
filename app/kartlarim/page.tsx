                  ...
                  >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => { setEditingCard(card); setIsDialogOpen(true); }}>
                    ...
                    <CardContent className={cn(
                      ...
                      <div>
                        ...
                        {/* Tarih Bilgileri - Ekstre Önce, Ödeme Sonra */}
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          {/* Sol: Ekstre Tarihi */}
                          {card.statementDate && (
                            <div className="flex items-center gap-2 text-xs p-2 rounded-md bg-blue-50 text-blue-700 border border-blue-200">
                              <Calendar className="h-4 w-4" />
                              <div className="flex flex-col">
                                <span className="text-[10px] opacity-70">Ekstre</span>
                                <span className="font-semibold">{card.statementDate}</span>
                              </div>
                            </div>
                          )}
                          
                          {/* Sağ: Son Ödeme Tarihi */}
                          {card.paymentDueDate && (
                            <div className={cn(
                              ...
                              <Calendar className="h-4 w-4" />
                              <div className="flex flex-col">
                                <span className="text-[10px] opacity-70">Son Ödeme</span>
                                <div className="flex items-center gap-1">
                                  <span className="font-semibold">{card.paymentDueDate}</span>
