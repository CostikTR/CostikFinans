            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="h-12 border-border/50 bg-transparent" onClick={() => handleOAuth("google")} disabled={loading}>
                    <Chrome className="h-4 w-4 mr-2" />
                    Google
                  </Button>
                  <Button variant="outline" className="h-12 border-border/50 bg-transparent" onClick={() => handleOAuth("github")} disabled={loading}>
